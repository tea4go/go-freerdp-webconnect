...
func main() {
	pflag.StringVarP(&rdpHost, "host", "", "192.168.52.127", "远程桌面服务器地址")
	pflag.IntVarP(&rdpPort, "port", "", 3389, "远程桌面服务器端口")
	pflag.StringVarP(&rdpUser, "user", "", "administrator", "用户名")
	pflag.StringVarP(&rdpPass, "pass", "", "testing123", "密码（可选，也可在网页表单中填写）")
